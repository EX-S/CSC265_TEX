...
\begin{addmargin}[1em]{0em}
    ...
    enqueued by the algorithm performed on $B$, $k$ and $x$, excluding nil.
    Then $P$ is a set.
    \begin{proof}
        B is a BST.
        ...
        \texibf{Inductive Step}
            ...
            \textit{Case 2:} $r \neq nil \aand r.$key $> x$
            \begin{addmargin}[1em]{0em}
               The condition on line 8 is satisfied and thus line 9 and 10 are excuted.
            ...
            Hense, $P$ is a set, no matter when the while loop halts.
    \end{proof}
\end{addmargin}
